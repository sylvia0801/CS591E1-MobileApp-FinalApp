...
public class Item implements Parcelable{
    ...
    public Item(String itemId, String tagId, String sellerId, String buyerId, String title, String productName, String price, String description,String url, String address, String status, String postRating, String rated) {
        this.itemId = itemId;
        this.tagId = tagId;
    ...
    public  String toString(){
        return "itemid: "+itemId+", tagid:"+tagId+" sellerId:"+sellerId+",buyerId: "+buyerId+", price:"+price+"+ rated:"+rated+", rating:"+postRating;
    }
}
